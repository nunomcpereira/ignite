...
| Zip-bomb / disk-exhaustion DoS via a malicious or oversized upload | Extracted size capped at 4 GB, upload capped at 1250 MB | Built-in size guards | pre-1 | N/A - built-in, no external tool involved |
...
- **Zip bombs:** total extracted size is capped at 4 GB; uploads capped at 1250 MB.
