 ...
 *   cosign, semgrep, bearer, guarddog, jscpd, gocloc, spectral } — each a
 *   binary name/path string. git/gh/act/docker aren't configurable, so
 *   they aren't parameters here.
 */
