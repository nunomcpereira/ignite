...
function normalizeIstanbul(data, projectRoot) {
  // Object.create(null): relPath comes from the uploaded report's own keys
  // (untrusted), so a plain {} would let a "__proto__" key repoint out's
  // prototype instead of just setting a data entry.
