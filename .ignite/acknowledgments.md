...
# Scanned against commit: 1b36cba4d8b4a97021784368a9161376951e18d3 (working tree at push time - findings/justifications below reflect this commit's code, not necessarily what ends up pushed if the tree changes after)
...
ID: secret::rust/crates/server/src/routes/pipeline_interactive.rs::1233
# Issue #4
# [ERROR] secret - Hardcoded aws-access-token
#   rust/crates/server/src/routes/pipeline_interactive.rs:1233
...
ID: secret::rust/crates/secrets/src/lib.rs::561
# Issue #5
# [ERROR] secret - Hardcoded connection-string credential
#   rust/crates/secrets/src/lib.rs:561
Acknowledge: Fake DATABASE_URL connection-string literal written to a scratch fixture file within a unit test for the new URI_CREDENTIAL_RE detector, not a real credential.
