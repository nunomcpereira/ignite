...
ID: secret::rust/crates/config/src/lib.rs::1452
# Issue #25
# [ERROR] secret - Hardcoded api_key
#   rust/crates/config/src/lib.rs:1452
...
ID: secret::rust/crates/config/src/lib.rs::1453
# Issue #26
# [ERROR] secret - Hardcoded secret
#   rust/crates/config/src/lib.rs:1453
...
ID: code-duplication::public/index.html::3187
# Issue #172
# [WARNING] code-duplication - 20-line duplicate block, also found in public/index.html:6095-6114.
#   public/index.html:3187
...
ID: code-duplication::public/index.html::5063
# Issue #173
# [WARNING] code-duplication - 25-line duplicate block, also found in public/index.html:5229-5253.
#   public/index.html:5063
# Code: body: JSON.stringify({ language }),
Acknowledge: 

ID: codeql-sast::public/index.html::1640::js/incomplete-html-attribute-sanitization
# Issue #174
...
#   public/index.html:1640
# Code: <button type="button" class="shrink-0 text-slate-300 hover:text-slate-600" aria-label="${escapeHtml(t('common.close'))}">
Acknowledge: 

ID: codeql-sast::public/index.html::3137::js/incomplete-html-attribute-sanitization
# Issue #175
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:3137
...
ID: codeql-sast::public/index.html::4890::js/incomplete-html-attribute-sanitization
# Issue #176
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:4890
...
ID: codeql-sast::public/index.html::6719::js/incomplete-html-attribute-sanitization
# Issue #177
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6719
# Code: reposOrgSelect.innerHTML = orgs.map((o) => `<option value="${escapeHtml(o)}">${escapeHtml(o)}</option>`).join('');
Acknowledge: 

ID: codeql-sast::public/index.html::6731::js/incomplete-html-attribute-sanitization
# Issue #178
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6731
# Code: select.innerHTML = orgs.map((o) => `<option value="${escapeHtml(o)}">${escapeHtml(o)}</option>`).join('');
Acknowledge: 

ID: codeql-sast::public/index.html::6823::js/incomplete-html-attribute-sanitization::e40e5cb3
# Issue #179
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6823
...
ID: codeql-sast::public/index.html::6825::js/incomplete-html-attribute-sanitization::e40e5cb3
# Issue #180
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6825
...
ID: codeql-sast::public/index.html::6826::js/incomplete-html-attribute-sanitization::e40e5cb3
# Issue #181
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6826
