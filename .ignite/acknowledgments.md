...
ID: code-duplication::rust/crates/server/src/routes/effectivate.rs::464
# Issue #184
# [WARNING] code-duplication - 20-line duplicate block, also found in rust/crates/server/src/routes/sarif.rs:72-91.
#   rust/crates/server/src/routes/effectivate.rs:464
# Code: use crate::state;
Acknowledge: 

ID: code-duplication::rust/crates/server/src/routes/effectivate.rs::469
# Issue #185
# [WARNING] code-duplication - 17-line duplicate block, also found in rust/crates/server/src/routes/sarif.rs:77-93.
#   rust/crates/server/src/routes/effectivate.rs:469
# Code: let db = ignite_db_store::DbStore::open(&db_dir.path().join("test.db")).unwrap();
Acknowledge: 

ID: code-duplication::rust/crates/server/src/routes/pipeline_onboard.rs::187
# Issue #186
# [WARNING] code-duplication - 16-line duplicate block, also found in rust/crates/server/src/routes/pipeline_validate.rs:245-259.
#   rust/crates/server/src/routes/pipeline_onboard.rs:187
# Code: let dry_run = body.get("dryRun").and_then(|v| v.as_bool()).unwrap_or(false);
Acknowledge: 

ID: code-duplication::rust/crates/server/src/routes/pipeline_onboard.rs::412
# Issue #187
# [WARNING] code-duplication - 24-line duplicate block, also found in rust/crates/server/src/routes/pipeline_validate.rs:476-499.
#   rust/crates/server/src/routes/pipeline_onboard.rs:412
# Code: logger.log(4, &format!("⚠ {} flagged issue(s) overridden by {}:", auto_applied.len(), actor.email));
Acknowledge: 

ID: code-duplication::rust/crates/server/src/routes/pipeline_onboard.rs::725
# Issue #188
# [WARNING] code-duplication - 37-line duplicate block, also found in rust/crates/server/src/routes/pipeline_validate.rs:867-903.
#   rust/crates/server/src/routes/pipeline_onboard.rs:725
# Code: state.db.finish_project("failed", Some(&e.message), None, None, project_id);
Acknowledge: 

ID: code-structure::rust/crates/server/src/main.rs::1
# Issue #189
# [WARNING] code-structure - rust/crates/server/src/main.rs is 1001 lines — over the 1000-line guideline. A single file this size usually means more than one responsibility living together, making it harder to review, test in isolation, and (for SAST tools that cache per-file) harder to scan incrementally.
