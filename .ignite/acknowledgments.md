...
ID: secret::rust/crates/config/src/lib.rs::1391
# Issue #23
# [ERROR] secret - Hardcoded api_key
#   rust/crates/config/src/lib.rs:1391
...
ID: secret::rust/crates/config/src/lib.rs::1392
# Issue #24
# [ERROR] secret - Hardcoded secret
#   rust/crates/config/src/lib.rs:1392
...
ID: code-duplication::CLAUDE.md:markdown::87
# Issue #54
# [WARNING] code-duplication - 24-line duplicate block, also found in CLAUDE.md:markdown:87-110.
#   CLAUDE.md:markdown:87
Acknowledge: 
...
ID: code-duplication::public/index.html::3014
# Issue #56
# [WARNING] code-duplication - 20-line duplicate block, also found in public/index.html:5910-5929.
#   public/index.html:3014
...
ID: code-duplication::public/index.html::4878
# Issue #57
# [WARNING] code-duplication - 25-line duplicate block, also found in public/index.html:5044-5068.
#   public/index.html:4878
...
ID: codeql-sast::public/index.html::1495::js/incomplete-html-attribute-sanitization
# Issue #89
...
#   public/index.html:1495
# Code: <button type="button" class="shrink-0 text-slate-300 hover:text-slate-600" aria-label="${escapeHtml(t('common.close'))}">
Acknowledge: 

ID: codeql-sast::public/index.html::2964::js/incomplete-html-attribute-sanitization
# Issue #90
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:2964
...
ID: codeql-sast::public/index.html::4705::js/incomplete-html-attribute-sanitization
# Issue #91
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:4705
...
ID: codeql-sast::public/index.html::6528::js/incomplete-html-attribute-sanitization
# Issue #92
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6528
# Code: select.innerHTML = orgs.map((o) => `<option value="${escapeHtml(o)}">${escapeHtml(o)}</option>`).join('');
Acknowledge: 

ID: codeql-sast::public/index.html::6617::js/incomplete-html-attribute-sanitization::e40e5cb3
# Issue #93
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6617
...
ID: codeql-sast::public/index.html::6619::js/incomplete-html-attribute-sanitization::e40e5cb3
# Issue #94
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6619
...
ID: codeql-sast::public/index.html::6620::js/incomplete-html-attribute-sanitization::e40e5cb3
# Issue #95
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6620
...
ID: dependency-vulnerability::rust/crates/server/Cargo.toml::63::jsonwebtoken::GHSA-h395-gr6q-cpjc
# Issue #177
...
#   rust/crates/server/Cargo.toml:63
# Code: jsonwebtoken = "9"
Acknowledge: 
