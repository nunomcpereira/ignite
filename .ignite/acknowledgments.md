...
ID: code-duplication::rust/crates/db-store/src/overrides.rs::212::f3a6aea1
# Issue #143
# [WARNING] code-duplication - 18-line duplicate block, also found in rust/crates/db-store/src/overrides.rs:260-277.
#   rust/crates/db-store/src/overrides.rs:212
# Code: stmt.query_map(params![project_id], |row| {
Acknowledge: 

ID: code-duplication::rust/crates/server/src/routes/effectivate.rs::311
# Issue #144
...
#   rust/crates/server/src/routes/effectivate.rs:311
...
ID: secret::rust/crates/config/src/lib.rs::1376
# Issue #146
# [ERROR] secret - Hardcoded api_key
#   rust/crates/config/src/lib.rs:1376
...
ID: secret::rust/crates/config/src/lib.rs::1377
# Issue #147
# [ERROR] secret - Hardcoded secret
#   rust/crates/config/src/lib.rs:1377
...
ID: code-duplication::CLAUDE.md:markdown::84
# Issue #152
# [WARNING] code-duplication - 24-line duplicate block, also found in CLAUDE.md:markdown:84-107.
#   CLAUDE.md:markdown:84
Acknowledge: 

ID: code-duplication::public/index.html::2940
# Issue #153
# [WARNING] code-duplication - 20-line duplicate block, also found in public/index.html:5836-5855.
#   public/index.html:2940
...
ID: code-duplication::public/index.html::4804
# Issue #154
# [WARNING] code-duplication - 25-line duplicate block, also found in public/index.html:4970-4994.
#   public/index.html:4804
# Code: body: JSON.stringify({ language }),
Acknowledge: 

ID: code-duplication::rust/crates/db-store/src/overrides.rs::212::2523c9d2
# Issue #155
...
# Issue #164
# [WARNING] code-structure - rust/crates/db-store/src/lib.rs is 1024 lines — over the 1000-line guideline. A single file this size usually means more than one responsibility living together, making it harder to review, test in isolation, and (for SAST tools that cache per-file) harder to scan incrementally.
...
# Issue #165
# [WARNING] code-structure - rust/crates/server/src/routes/pipeline_validate.rs is 1035 lines — over the 1000-line guideline. A single file this size usually means more than one responsibility living together, making it harder to review, test in isolation, and (for SAST tools that cache per-file) harder to scan incrementally.
#   rust/crates/server/src/routes/pipeline_validate.rs:1
# Code: //! POST /api/pipeline/validate-all — faithful port of
Acknowledge: 

ID: codeql-sast::public/index.html::1490::js/incomplete-html-attribute-sanitization
# Issue #166
...
#   public/index.html:1490
# Code: <button type="button" class="shrink-0 text-slate-300 hover:text-slate-600" aria-label="${escapeHtml(t('common.close'))}">
Acknowledge: 

ID: codeql-sast::public/index.html::2890::js/incomplete-html-attribute-sanitization
# Issue #167
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:2890
...
ID: codeql-sast::public/index.html::4631::js/incomplete-html-attribute-sanitization
# Issue #168
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:4631
...
ID: codeql-sast::public/index.html::6454::js/incomplete-html-attribute-sanitization
# Issue #169
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6454
# Code: select.innerHTML = orgs.map((o) => `<option value="${escapeHtml(o)}">${escapeHtml(o)}</option>`).join('');
Acknowledge: 

ID: codeql-sast::public/index.html::6543::js/incomplete-html-attribute-sanitization::e40e5cb3
# Issue #170
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6543
...
ID: codeql-sast::public/index.html::6545::js/incomplete-html-attribute-sanitization::e40e5cb3
# Issue #171
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6545
...
ID: codeql-sast::public/index.html::6546::js/incomplete-html-attribute-sanitization::e40e5cb3
# Issue #172
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6546
