...
ID: code-duplication::CLAUDE.md:markdown::90
# Issue #171
# [WARNING] code-duplication - 25-line duplicate block, also found in CLAUDE.md:markdown:90-114.
#   CLAUDE.md:markdown:90
Acknowledge: 

ID: code-duplication::public/index.html::3183
# Issue #172
# [WARNING] code-duplication - 20-line duplicate block, also found in public/index.html:6091-6110.
#   public/index.html:3183
...
ID: code-duplication::public/index.html::5059
# Issue #173
# [WARNING] code-duplication - 25-line duplicate block, also found in public/index.html:5225-5249.
#   public/index.html:5059
# Code: body: JSON.stringify({ language }),
Acknowledge: 

ID: codeql-sast::public/index.html::1636::js/incomplete-html-attribute-sanitization
# Issue #174
...
#   public/index.html:1636
# Code: <button type="button" class="shrink-0 text-slate-300 hover:text-slate-600" aria-label="${escapeHtml(t('common.close'))}">
Acknowledge: 

ID: codeql-sast::public/index.html::3133::js/incomplete-html-attribute-sanitization
# Issue #175
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:3133
...
ID: codeql-sast::public/index.html::4886::js/incomplete-html-attribute-sanitization
# Issue #176
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:4886
...
ID: codeql-sast::public/index.html::6711::js/incomplete-html-attribute-sanitization
# Issue #177
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6711
# Code: select.innerHTML = orgs.map((o) => `<option value="${escapeHtml(o)}">${escapeHtml(o)}</option>`).join('');
Acknowledge: 

ID: codeql-sast::public/index.html::6803::js/incomplete-html-attribute-sanitization::e40e5cb3
# Issue #178
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6803
...
ID: codeql-sast::public/index.html::6805::js/incomplete-html-attribute-sanitization::e40e5cb3
# Issue #179
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6805
...
ID: codeql-sast::public/index.html::6806::js/incomplete-html-attribute-sanitization::e40e5cb3
# Issue #180
# [WARNING] codeql-sast - Cross-site scripting vulnerability as the output of this final HTML sanitizer step may contain double quotes when it reaches this attribute definition.
#   public/index.html:6806
