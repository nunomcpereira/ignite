...
# Scanned against commit: 3f3b3059ed34116e4dcba9657a96883c5e517a12 (working tree at push time - findings/justifications below reflect this commit's code, not necessarily what ends up pushed if the tree changes after)
...
ID: secret::rust/crates/secrets/src/lib.rs::989
# Issue #24
# [ERROR] secret - Hardcoded stripe-access-token
#   rust/crates/secrets/src/lib.rs:989
...
ID: secret::rust/crates/secrets/src/lib.rs::991
# Issue #25
# [ERROR] secret - Hardcoded stripe-access-token
#   rust/crates/secrets/src/lib.rs:991
