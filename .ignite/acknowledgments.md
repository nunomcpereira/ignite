...
ID: code-duplication::rust/crates/server/src/routes/effectivate.rs::408
# Issue #184
# [WARNING] code-duplication - 20-line duplicate block, also found in rust/crates/server/src/routes/sarif.rs:72-91.
#   rust/crates/server/src/routes/effectivate.rs:408
# Code: use crate::state;
Acknowledge: 

ID: code-duplication::rust/crates/server/src/routes/effectivate.rs::413
# Issue #185
# [WARNING] code-duplication - 17-line duplicate block, also found in rust/crates/server/src/routes/sarif.rs:77-93.
#   rust/crates/server/src/routes/effectivate.rs:413
# Code: let db = ignite_db_store::DbStore::open(&db_dir.path().join("test.db")).unwrap();
Acknowledge: 

ID: code-duplication::rust/crates/server/src/routes/pipeline_onboard.rs::329
# Issue #186
# [WARNING] code-duplication - 24-line duplicate block, also found in rust/crates/server/src/routes/pipeline_validate.rs:474-497.
#   rust/crates/server/src/routes/pipeline_onboard.rs:329
# Code: logger.log(4, &format!("⚠ {} flagged issue(s) overridden by {}:", auto_applied.len(), actor.email));
Acknowledge: 

ID: code-duplication::rust/crates/server/src/routes/pipeline_onboard.rs::422
# Issue #187
# [WARNING] code-duplication - 16-line duplicate block, also found in rust/crates/server/src/routes/pipeline_validate.rs:566-581.
#   rust/crates/server/src/routes/pipeline_onboard.rs:422
# Code: .actor(actor.email.clone())
Acknowledge: 

ID: code-duplication::rust/crates/server/src/routes/pipeline_onboard.rs::593
# Issue #188
# [WARNING] code-duplication - 36-line duplicate block, also found in rust/crates/server/src/routes/pipeline_validate.rs:865-900.
#   rust/crates/server/src/routes/pipeline_onboard.rs:593
